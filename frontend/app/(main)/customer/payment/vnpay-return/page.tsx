    ...
    useEffect(() => {
        const processPayment = async () => {
            try {
                ...
                // Gọi API xử lý callback từ VNPay
                const response = await fetch(`${API_BASE_URL}/api/orders/vnpay_return/?${params.toString()}`);
                ...
                <div className="card">
                    {paymentResult?.is_success ? (
                        <div className="text-center py-8">
                            ...
                            <h3 className="text-green-500">Thanh toán thành công!</h3>
                            <p className="text-500 mb-4">Cảm ơn bạn đã thanh toán đơn hàng</p>
                            ...
                            <div className="surface-100 p-4 border-round mb-4 inline-block text-left">
                                <div className="grid">
                                    ...
                                    <div className="col-12 md:col-6 mb-3">
                                        ...
                                        <div className="font-bold">{paymentResult.transaction_no}</div>
                                    </div>
                                    <div className="col-12 md:col-6 mb-3">
                                        <div className="text-500 mb-1">Ngân hàng:</div>
                                        <div className="font-bold">{paymentResult.bank_code}</div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="text-center py-8">
                            <i className="pi pi-times-circle text-6xl text-red-500 mb-4"></i>
                            <h3 className="text-red-500">Thanh toán thất bại</h3>
                            <p className="text-500 mb-2">{paymentResult?.message || 'Có lỗi xảy ra trong quá trình thanh toán'}</p>
                                ...
                                <div className="surface-100 p-4 border-round mb-4 inline-block text-left">
                                    <div className="grid">
                                        ...
                                        <div className="col-12 mb-2">
                                            ...
                                            <div className="font-bold text-red-500">{paymentResult.response_code}</div>
                                        </div>
                                    </div>
                                </div>
                            )}
